...
<div className="mb-3">
  ...
  <input type="text" className="form-control" id="exampleInputEmail1" name="title" onChange={changeValue}/>
</div>
...
<div className="mb-3">
 ...
 <div className="mb-3 form-check">
  <input type="checkbox" className="form-check-input" id="exampleCheck1" name='acceptTerms' onClick={changeValue}/>
